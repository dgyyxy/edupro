...
import static com.edu.common.util.StringUtil.lineToHump;

/**
 * 代码生成类
 * Created by Gary on 2017/1/10.
 */
public class MybatisGeneratorUtil {

	// generatorConfig模板路径
	private static String generatorConfig_vm = "common/src/main/resources/template/generatorConfig.vm";
	// Service模板路径
	private static String service_vm = "common/src/main/resources/template/Service.vm";
	// ServiceMock模板路径
	private static String serviceMock_vm = "common/src/main/resources/template/ServiceMock.vm";
	// ServiceImpl模板路径
	private static String serviceImpl_vm = "common/src/main/resources/template/ServiceImpl.vm";
