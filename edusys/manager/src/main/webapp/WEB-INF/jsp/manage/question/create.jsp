...
<script>
    ...
    // 获取表单提交数据
    function getData(){
        var obj = $('#createForm').serializeObject();
    ...
    function createSubmit() {
        if(verifyInput()){
            $.ajax({
                type: 'post',
                url: '${basePath}/manage/question/create',
                data: getData(),
                beforeSend: function() {
                },
    ...
    function answerMuit(optlen){
        ...
        for(var i=0;i<optlen;i++){
            htmlstr += '<input type="checkbox" class="answerR" value="'+String.fromCharCode(65 + i)+'"/>&nbsp;'+String.fromCharCode(65 + i)+'&nbsp;&nbsp;';
        }
