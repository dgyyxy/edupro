    ...
    <section id="content">
        ...
        <div class="content_main">
            <div id="iframe_home" class="iframe cur">
                <p><h4>考试学习管理系统 </h4></p>
                <p><b>系统简介</b>：<br/>
                    航空CBT在线系统是一套应用于局域网内的BS结构软件系统，从用户登录、课件管理、学习记录、考试设置、系统管理等各方面应用都具备简便、稳定的特点。</p>
                <p>系统在客户端具有学生、教师两个入口，以桌面快捷程序方式打开服务，相应页面封装于应用框架内；系统也应具备足够的技术稳定性、扩展性和先进性，客户端无需安装任何插件，以软件应用方式访问学习。
                </p>
            </div>
        </div>
    </section>
