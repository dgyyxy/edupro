...
<div id="main">
	<div id="toolbar">
        <a class="waves-effect waves-button" href="javascript:;" onclick="createAction()"><i class="zmdi zmdi-plus"></i> 新增分类</a>
...
function createAction() {
	createDialog = $.dialog({
		...
		animationSpeed: 300,
		title: '新增类型',
		content: 'url:${basePath}/manage/question/type/create',
...
function updateAction() {
	...
	if (rows.length != 1) {
		...
		updateDialog = $.dialog({
			...
			animationSpeed: 300,
			title: '编辑类型',
			content: 'url:${basePath}/manage/question/type/update/' + rows[0].id,
			onContentReady: function () {
				initMaterialInput();
			}
		});
			...
			buttons: {
				confirm: {
					...
					action: function () {
						...
						$.ajax({
							type: 'get',
							url: '${basePath}/manage/question/type/delete/' + ids.join("-"),
